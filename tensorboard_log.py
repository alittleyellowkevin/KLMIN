...
if __name__ == "__main__":
    ...
    dicttest = {"Loss/train_total": np.mean([4, 2, 1]), "Loss/train_crossentropy": np.mean([12, 32, 3]),
                "Loss/train_triplet": np.mean([223, 11]), "Loss/ce_loss_weight": np.mean([[2, 8, 6, 4, 4]]),
                "Loss/triplet_loss_weight": np.mean([1, 1])}
